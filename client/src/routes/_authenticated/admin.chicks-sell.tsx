...
export const Route = createFileRoute("/_authenticated/admin/chicks-sell")({
  component: AdminChicksSell,
});

function AdminChicksSell() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      toast.success("Chicken listing published live!");
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="container mx-auto max-w-2xl px-4 py-10">
        ...
        <h1 className="mt-4 font-display text-3xl font-semibold text-primary">New Chicken Listing</h1>
        <p className="mt-1 text-muted-foreground">
          Directly create a new chicken or egg listing and publish it to the marketplace.
        </p>
        ...
        <form onSubmit={submit} className="mt-6 space-y-5 rounded-2xl border border-border bg-card p-6 shadow-soft">
          <div>
            ...
            <Input 
              ...
              placeholder="Healthy broiler chickens, 8 weeks" 
            />
          </div>
          ...
          <div>
            ...
            <Textarea id="description" rows={4} value={form.description} onChange={(e) => setForm({ ...form, description: e.target.value })} placeholder="Diet, age, vaccination schedule..." />
          </div>
