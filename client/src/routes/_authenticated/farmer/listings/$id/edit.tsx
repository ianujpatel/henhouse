  ...
  useEffect(() => {
    if (listing && !form) {
      ...
      setForm({
        ...
        target_audience: listing.target_audience ?? "both",
      });
    ...
    try {
      await updateFn({
        data: {
          ...
          unit: form.unit,
          farmer_price: isAdmin ? Number(form.farmer_price) : listing.farmer_price,
          ...
          target_audience: isAdmin ? form.target_audience : (listing.target_audience ?? "both"),
        },
      });
